...
import { ArrowRight, BookOpen, ClipboardList, Languages, PenLine, ScanSearch } from 'lucide-react'
  ...
  return (
    <section className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:col-span-2">
      <div className="mb-3 flex items-center gap-2">
        ...
        <div>
          <h3 className="font-bold text-slate-900">Nhận diện chữ</h3>
          <p className="text-xs text-slate-500">Nhìn chữ Hán → chọn nghĩa</p>
        </div>
      </div>

      <div className="mb-4 flex flex-wrap gap-2 text-xs">
        <span className="rounded-full bg-slate-100 px-2.5 py-1 text-slate-600">Quiz 4 đáp án</span>
        <span className="rounded-full bg-slate-100 px-2.5 py-1 text-slate-600">Ôn chữ yếu</span>
      </div>
