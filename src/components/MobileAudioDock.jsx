...
export default function MobileAudioDock({ bookId, tracks }) {
  ...
  return (
    <div
      className={`fixed left-0 right-0 z-20 border-t border-teal-200 bg-white/95 px-4 py-3 shadow-[0_-4px_16px_rgba(0,0,0,0.08)] backdrop-blur safe-x lg:hidden ${
        playerVisible ? 'mobile-dock-above-player' : 'bottom-0 safe-bottom'
      }`}
    >
